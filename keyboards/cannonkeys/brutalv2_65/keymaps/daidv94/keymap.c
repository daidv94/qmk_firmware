...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_all(
		...
		KC_GRV,  KC_LALT, KC_LGUI,                            KC_SPC,                             MO(1), KC_CAPS,          KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_FN] = LAYOUT_all(
		QK_BOOT, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_BACKSPACE, _______,
		_______, _______, _______, KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
